...
//Name: m_hallwayLevel21Wall_br_an.ma
//Last modified: Sun, Feb 16, 2014 04:09:36 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 27.72564311472518 17.356900790153482 -2.5541854054926496 ;
	setAttr ".r" -type "double3" -20.73835272944951 -637.7999999999397 -1.1717721940227529e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 32.546228195355084;
...
// End of m_hallwayLevel21Wall_br_an.ma
