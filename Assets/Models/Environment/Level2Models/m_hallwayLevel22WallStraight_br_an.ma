...
//Name: m_hallwayLevel22WallStraight_br_an.ma
//Last modified: Fri, Feb 28, 2014 08:49:40 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.5827319985279082 12.939999174223573 21.652554241714114 ;
	setAttr ".r" -type "double3" -17.138352729243852 -701.4000000001023 -8.3895882366174179e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 37.661350438706997;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 2.8497271432245501 -4.995617048606392 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 4.4489535519296917;
...
connectAttr "pasted__pillarFull_pillar1.mwc" "polySurfaceShape2.iog.og[0].gco";
connectAttr "groupId33.id" "polySurfaceShape2.iog.og[1].gid";
connectAttr "pasted__pillarFull_hallwaySide1.mwc" "polySurfaceShape2.iog.og[1].gco"
		;
connectAttr "groupId34.id" "polySurfaceShape2.iog.og[2].gid";
connectAttr "pasted__pillarFull_pillarFull_hallway.mwc" "polySurfaceShape2.iog.og[2].gco"
		;
connectAttr "groupId35.id" "polySurfaceShape2.iog.og[3].gid";
connectAttr "pasted__default1.mwc" "polySurfaceShape2.iog.og[3].gco";
connectAttr "groupId36.id" "polySurfaceShape2.iog.og[4].gid";
connectAttr "pasted__pillarFull_initialShadingGroup.mwc" "polySurfaceShape2.iog.og[4].gco"
		;
connectAttr "groupId37.id" "polySurfaceShape3.iog.og[0].gid";
connectAttr "pasted__pPlane1SG1.mwc" "polySurfaceShape3.iog.og[0].gco";
connectAttr "groupId38.id" "polySurfaceShape7.iog.og[0].gid";
connectAttr "pasted__pasted__pillarFull_pillar1.mwc" "polySurfaceShape7.iog.og[0].gco"
		;
connectAttr "groupId39.id" "polySurfaceShape7.iog.og[1].gid";
connectAttr "pasted__pasted__pillarFull_hallwaySide1.mwc" "polySurfaceShape7.iog.og[1].gco"
		;
connectAttr "groupId40.id" "polySurfaceShape7.iog.og[2].gid";
connectAttr "pasted__pasted__pillarFull_pillarFull_hallway.mwc" "polySurfaceShape7.iog.og[2].gco"
		;
connectAttr "groupId41.id" "polySurfaceShape7.iog.og[3].gid";
connectAttr "pasted__pasted__default1.mwc" "polySurfaceShape7.iog.og[3].gco";
connectAttr "groupId42.id" "polySurfaceShape7.iog.og[4].gid";
connectAttr "pasted__pasted__pillarFull_initialShadingGroup.mwc" "polySurfaceShape7.iog.og[4].gco"
		;
connectAttr "groupId43.id" "polySurfaceShape8.iog.og[0].gid";
connectAttr "pasted__pasted__pPlane1SG1.mwc" "polySurfaceShape8.iog.og[0].gco";
connectAttr "groupId44.id" "polySurfaceShape12.iog.og[0].gid";
connectAttr "pasted__polySurface1SG1.mwc" "polySurfaceShape12.iog.og[0].gco";
connectAttr "groupId45.id" "polySurfaceShape13.iog.og[0].gid";
connectAttr "pasted__pasted__polySurface1SG1.mwc" "polySurfaceShape13.iog.og[0].gco"
		;
...
connectAttr "polySurfaceShape3.iog.og[0]" "pasted__pPlane1SG1.dsm" -na;
...
connectAttr "polySurfaceShape12.iog.og[0]" "pasted__polySurface1SG1.dsm" -na;
connectAttr "groupId44.msg" "pasted__polySurface1SG1.gn" -na;
connectAttr "groupId32.msg" "pasted__pillarFull_pillar1.gn" -na;
connectAttr "polySurfaceShape2.iog.og[0]" "pasted__pillarFull_pillar1.dsm" -na;
connectAttr "groupId33.msg" "pasted__pillarFull_hallwaySide1.gn" -na;
connectAttr "polySurfaceShape2.iog.og[1]" "pasted__pillarFull_hallwaySide1.dsm" 
		-na;
connectAttr "groupId34.msg" "pasted__pillarFull_pillarFull_hallway.gn" -na;
connectAttr "polySurfaceShape2.iog.og[2]" "pasted__pillarFull_pillarFull_hallway.dsm"
		 -na;
connectAttr "groupId35.msg" "pasted__default1.gn" -na;
connectAttr "polySurfaceShape2.iog.og[3]" "pasted__default1.dsm" -na;
...
connectAttr "polySurfaceShape2.iog.og[4]" "pasted__pillarFull_initialShadingGroup.dsm"
		 -na;
...
connectAttr "polySurfaceShape7.iog.og[0]" "pasted__pasted__pillarFull_pillar1.dsm"
		 -na;
connectAttr "groupId39.msg" "pasted__pasted__pillarFull_hallwaySide1.gn" -na;
connectAttr "polySurfaceShape7.iog.og[1]" "pasted__pasted__pillarFull_hallwaySide1.dsm"
		 -na;
connectAttr "groupId40.msg" "pasted__pasted__pillarFull_pillarFull_hallway.gn" -na
		;
connectAttr "polySurfaceShape7.iog.og[2]" "pasted__pasted__pillarFull_pillarFull_hallway.dsm"
		 -na;
connectAttr "groupId41.msg" "pasted__pasted__default1.gn" -na;
connectAttr "polySurfaceShape7.iog.og[3]" "pasted__pasted__default1.dsm" -na;
...
connectAttr "groupId42.msg" "pasted__pasted__pillarFull_initialShadingGroup.gn" 
		-na;
connectAttr "polySurfaceShape7.iog.og[4]" "pasted__pasted__pillarFull_initialShadingGroup.dsm"
		 -na;
...
connectAttr "polySurfaceShape8.iog.og[0]" "pasted__pasted__pPlane1SG1.dsm" -na;
...
connectAttr "polySurfaceShape13.iog.og[0]" "pasted__pasted__polySurface1SG1.dsm"
		 -na;
...
// End of m_hallwayLevel22WallStraight_br_an.ma
