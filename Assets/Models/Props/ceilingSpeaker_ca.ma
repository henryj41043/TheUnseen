...
//Last modified: Thu, Mar 06, 2014 09:51:55 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.66544959360472922 -0.14190703320462505 0.79869740914704623 ;
	setAttr ".r" -type "double3" 8.6616472704138108 39.800000000005383 5.1747736737006106e-016 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "ceilingSpeaker";
createNode mesh -n "ceilingSpeakerShape" -p "ceilingSpeaker";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode renderLayer -n "defaultRenderLayer";
	setAttr ".g" yes;
createNode lambert -n "ceiingSpeaker_mat";
...
createNode psdFileTex -n "n_ceilingSpeaker";
	setAttr ".ftn" -type "string" "C:/Users/Anna/Desktop/Dylan - WK09/ceilingSpeaker_ca.psd";
...
connectAttr "n_ceilingSpeaker.oc" "ceiingSpeaker_mat.c";
connectAttr "ceiingSpeaker_mat.oc" "lambert2SG.ss";
connectAttr "ceilingSpeakerShape.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "ceiingSpeaker_mat.msg" "materialInfo1.m";
connectAttr "n_ceilingSpeaker.msg" "materialInfo1.t" -na;
...
connectAttr "place2dTexture2.c" "n_ceilingSpeaker.c";
connectAttr "place2dTexture2.tf" "n_ceilingSpeaker.tf";
connectAttr "place2dTexture2.rf" "n_ceilingSpeaker.rf";
connectAttr "place2dTexture2.mu" "n_ceilingSpeaker.mu";
connectAttr "place2dTexture2.mv" "n_ceilingSpeaker.mv";
connectAttr "place2dTexture2.s" "n_ceilingSpeaker.s";
connectAttr "place2dTexture2.wu" "n_ceilingSpeaker.wu";
connectAttr "place2dTexture2.wv" "n_ceilingSpeaker.wv";
connectAttr "place2dTexture2.re" "n_ceilingSpeaker.re";
connectAttr "place2dTexture2.of" "n_ceilingSpeaker.of";
connectAttr "place2dTexture2.r" "n_ceilingSpeaker.ro";
connectAttr "place2dTexture2.n" "n_ceilingSpeaker.n";
connectAttr "place2dTexture2.vt1" "n_ceilingSpeaker.vt1";
connectAttr "place2dTexture2.vt2" "n_ceilingSpeaker.vt2";
connectAttr "place2dTexture2.vt3" "n_ceilingSpeaker.vt3";
connectAttr "place2dTexture2.vc1" "n_ceilingSpeaker.vc1";
connectAttr "place2dTexture2.o" "n_ceilingSpeaker.uv";
connectAttr "place2dTexture2.ofs" "n_ceilingSpeaker.fs";
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "ceiingSpeaker_mat.msg" ":defaultShaderList1.s" -na;
connectAttr "psdFileTex1.msg" ":defaultTextureList1.tx" -na;
connectAttr "n_ceilingSpeaker.msg" ":defaultTextureList1.tx" -na;
