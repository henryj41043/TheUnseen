...
public class PauseState : MonoBehaviour
{
	...
	void Update()
	{
		if (GameObject.Find("CharacterStart").GetComponent<CharacterStart>().playerHasSpawned)
		{
			GameObject.Find("CharacterStart").GetComponent<CharacterStart>().playerHasSpawned = false;
