...
[AddComponentMenu("Character/Character Mover")]

//Trying to find modified code?  Look for "Ryan Made This"

//need to make pushpower and the "can i stand up" checks
...
public class CharacterMover : MonoBehaviour
{
	...
	public CharacterMoverMovement movement = new CharacterMoverMovement();
	...
	[System.Serializable]
	public class CharacterMoverJumping
	{
	...
	public CharacterMoverJumping jumping = new CharacterMoverJumping();
	
	[System.Serializable]
	public class CharacterMoverMovingPlatform
	{
		public bool enabled = true;
	...
	public CharacterMoverMovingPlatform movingPlatform = new CharacterMoverMovingPlatform();
	
	[System.Serializable]
	public class CharacterMoverSliding
	{
	...
	public CharacterMoverSliding sliding = new CharacterMoverSliding();
	...
	float MaxSpeedInDirection(Vector3 desiredMovementDirection)
	{
		...
		//Ryan Made This!
		float modifiedMaxForward = movement.maxForwardSpeed * movement.generalSpeedModifier;
		float modifiedMaxBackwards = movement.maxBackwardsSpeed * movement.generalSpeedModifier;
		float modifiedMaxSideways = movement.maxSidewaysSpeed * movement.generalSpeedModifier;

		//Ryan Made This!
		if (grounded && inputSprint && !movement.isCrouching){
			stats.DrainSprint();
			if (stats.sprintEnergy > 0) {
